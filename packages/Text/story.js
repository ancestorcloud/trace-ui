...
import { Action, Title, Alert, Heading, Label, P } from './index'
  ...
  .add('label', () => (
    <div>
      ...
      <div style={{width: '400px'}}>
        <Label type='urgent' head='Urgent Label'>I have a 400px wide container</Label>
      </div>
      <Label type='passive' head='Passive label'>900 & 300, 15PX</Label>
      <Label type='urgent'>Respond to your helper's proposals by clicking stuff</Label>
    </div>
  ))
  .add('title', () => (
    <div>
